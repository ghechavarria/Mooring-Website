...
- **Breakpoint:** Primary nav and desktop CTAs use `md:flex`; the menu control is `md:hidden`.
...
- **Mobile links:** Same anchors as desktop, plus **Client access** and **Request a briefing**.
