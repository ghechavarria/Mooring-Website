...
- **Footer:** Closing line under the strip (integrated: dark bar; panel: light bar) — benefit-forward copy, e.g. **“Mooric ERP — give your loan team this clarity on every file.”** The pulse above remains **decorative** (`aria-hidden`); this line nudges interest without claiming live tenant data.
