...
Defined in [`src/index.css`](../src/index.css) (`@layer components`). Class name is historical; the control uses the same **ERP blue** as the nav wordmark (**`erp`** in [`tailwind.config.js`](../tailwind.config.js), **`#0075FF`**). Used for **`Request a briefing`** ([`Header.tsx`](../src/components/Header.tsx), [`Hero.tsx`](../src/components/Hero.tsx), mobile nav) and **`Book a walkthrough`** ([`ContactCTA.tsx`](../src/components/ContactCTA.tsx)).
