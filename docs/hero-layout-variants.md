...
2. **Navy left column** (~45%) — one vertically centered stack: *Less chasing paperwork / More time closing loans* (silver metal photo fill), body, CTAs, then stats. The AI pill sits on the photo under the title.
