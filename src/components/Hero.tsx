      ...
      <div className="relative flex w-full flex-1 flex-col">
        <HeroSessionPulse>
          ...
          <motion.div
            ...
            className="w-full"
          >
            <p className="flex items-center gap-3 text-[11px] font-semibold uppercase tracking-[0.22em] text-erp">
              <span className="h-px w-10 shrink-0 bg-erp sm:w-14" aria-hidden />
              Intelligent Automation. Real Results.
            </p>
            <h1
              id="hero-heading"
              className="mt-3 text-balance font-serif text-4xl font-semibold leading-[1.1] tracking-tight text-ink-950 sm:text-5xl lg:text-6xl xl:text-[3.35rem] xl:leading-[1.08]"
            >
              Less chasing paperwork. More time closing loans.
            </h1>
            <p className="mt-5 max-w-none text-base leading-relaxed text-organ-800 sm:text-lg lg:mt-6 lg:max-w-4xl xl:max-w-5xl xl:text-xl xl:leading-relaxed">
            ...
            <dl className="mt-10 grid w-full gap-8 border-t border-organ-200 pt-8 sm:grid-cols-3 sm:gap-10 lg:mt-12 lg:gap-14 lg:pt-10 xl:gap-20">
              <div>
                <dt className="text-[11px] font-semibold uppercase tracking-wide text-erp">
                  1003
                </dt>
